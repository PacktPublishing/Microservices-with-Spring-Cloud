...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private boolean isAccessingWithContextPath(HttpServletRequest httpServletRequest) {
        return managementServerProperties.getPort() == null &&
                managementServerProperties.getServlet().getContextPath() != null &&
                httpServletRequest.getServletPath().startsWith(managementServerProperties.getServlet().getContextPath());
    }
}
